...
cd /home/FCAM/eeb5300/usr14/5300_labs/week10-class_portion/04_aligning/the-rest
...
INDIR=../../02_quality-control/01_trimmed_sequences
OUTDIR=.
...
ACCLIST=../../01_raw-data/accessionlist2.txt
